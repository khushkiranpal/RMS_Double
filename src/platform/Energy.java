...
public class Energy {
	...
	private final static double Max_Freq_Dependent_Power = 1.52*1*1*1;
	private final static double S_critical=0.15; 
...
//		System.out.println("  power  "+power);
	...
	{
		return(0.08 + 1.52*S_critical*S_critical*S_critical);
